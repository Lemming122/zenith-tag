...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "1BF28"  # Playfab Title Id
        self.SecretKey: str = "79Z3DUAIHR1NF6HD1NXU9J67F9DA3WSKB4IQE1XBWGEO18NENG"  # Playfab Secret Key
        self.ApiKey: str = "OC|1159389190585397|0db244fbf8150c8eb045945483e381e6"  # App Api Key (Oculus/Graph API)
...
def titledata():
    response_data = {
        ...
        "BundleBoardSign": "<color=#ff4141>DISCORD.GG/ZENITHTAG</color>",
        ...
        "TOBDefPurchaseBtnDefTxt": "ZENITH TAG",
        # Legal and Versions
        ...
        "NewsFeedUrl": "https://DISCORD.GG/ZENITHTAG",
        ...
        "BanAppealUrl": "https://DISCORD.GG/ZENITHTAG",
        ...
        "FeedbackSubmissionUrl": "https://DISCORD.GG/ZENITHTAG/feedback"
    }
